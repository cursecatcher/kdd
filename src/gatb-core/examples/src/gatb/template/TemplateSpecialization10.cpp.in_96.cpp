...
template void bcalm2<96>(Storage* storage, 
        std::string prefix,
        int kmerSize, 
        int abundance, 
        int minSize, 
...
template void bglue<96>(Storage* storage, 
        std::string prefix,
        int kmerSize, 
...
template class graph3<96>; // graph3<span> switch  

template void link_tigs<96>
...
template void link_unitigs_pass<96>(const std::string unitigs_filename, bool verbose, const int pass, const int kmerSize, bool edge_km_representation, const bool renumber_unitigs);
