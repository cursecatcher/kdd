...
get_filename_component(PACKAGE_PREFIX_DIR "${CMAKE_CURRENT_LIST_DIR}/../../../../../../../../../usr/local/HDF_Group/HDF5/1.10.5" ABSOLUTE)
...
set (${HDF5_PACKAGE_NAME}_EXPORT_LIBRARIES hdf5-static;hdf5_tools-static)
...
# Directories
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR "/home/cursed/gitgud/gatb-core/gatb-core/examples/include/Debug/hdf5" "${${HDF5_PACKAGE_NAME}_MPI_C_INCLUDE_DIRS}")

set (${HDF5_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}//home/cursed/gitgud/gatb-core/gatb-core/examples/share/Debug")
set_and_check (${HDF5_PACKAGE_NAME}_BUILD_DIR "${PACKAGE_PREFIX_DIR}")

if (${HDF5_PACKAGE_NAME}_BUILD_CPP_LIB)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_CPP "/home/cursed/gitgud/gatb-core/gatb-core/examples/include/Debug/hdf5")
endif ()

if (${HDF5_PACKAGE_NAME}_BUILD_HL_LIB)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_HL "/home/cursed/gitgud/gatb-core/gatb-core/examples/include/Debug/hdf5")
endif ()

if (${HDF5_PACKAGE_NAME}_BUILD_HL_LIB AND ${HDF5_PACKAGE_NAME}_BUILD_CPP_LIB)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_HL_CPP "/home/cursed/gitgud/gatb-core/gatb-core/examples/include/Debug/hdf5")
endif ()

if (${HDF5_PACKAGE_NAME}_BUILD_TOOLS)
  set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_TOOLS "/home/cursed/gitgud/gatb-core/gatb-core/examples/include/Debug/hdf5")
...
if (NOT TARGET "hdf5")
  if (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS AND NOT TARGET "zlib")
    include (${PACKAGE_PREFIX_DIR}//home/cursed/gitgud/gatb-core/gatb-core/examples/share/Debug//-targets.cmake)
  endif ()
  if (${HDF5_PACKAGE_NAME}_ENABLE_SZIP_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS AND NOT TARGET "szip")
    include (${PACKAGE_PREFIX_DIR}//home/cursed/gitgud/gatb-core/gatb-core/examples/share/Debug//-targets.cmake)
  endif ()
  include (${PACKAGE_PREFIX_DIR}//home/cursed/gitgud/gatb-core/gatb-core/examples/share/Debug/hdf5/hdf5-targets.cmake)
endif ()
...
foreach (comp IN LISTS ${HDF5_PACKAGE_NAME}_FIND_COMPONENTS)
  if (${comp} STREQUAL "shared")
    ...
    if (${HDF5_PACKAGE_NAME}_BUILD_FORTRAN)
      set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_FORTRAN "/home/cursed/gitgud/gatb-core/gatb-core/examples/include/Debug/hdf5/shared")
    endif ()
  elseif (${comp} STREQUAL "static")
    ...
    if (${HDF5_PACKAGE_NAME}_BUILD_FORTRAN)
      set (${HDF5_PACKAGE_NAME}_INCLUDE_DIR_FORTRAN "/home/cursed/gitgud/gatb-core/gatb-core/examples/include/Debug/hdf5/static")
    endif ()
  endif ()
endforeach ()
